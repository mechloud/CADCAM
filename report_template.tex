...
\usepackage{gensymb} %used to generate symboles such as degree signs \degree
...
\usepackage{subfiles}
\usepackage{chngcntr} % Used to rename figures using appendix number in appendix
\urlstyle{same}
...
\fancyhead[RE,LO]{Modelling Report}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center} % Center everything on the page
			...
			\HRule \\[0.4cm]
			{ \huge \bfseries Modelling Report}\\[0.4cm] % Title of your document
			\HRule \\[0.5cm]
    ...
    \newpage
    \setstretch{1.0} % Line spacing 1.0

    % This command allows long URL's to word-wrap when printing references.
    ...
    %  Signals the start of appendices
    \appendix

    % Changes the number of figures in appendix to a letter and a number. Example: The first figure in appendix A will be 'Figure A.1'
    \counterwithin{figure}{subsection}

    % Plain page style: removes headers and footers from pages in appendix. Need to do this for every new page in appendix, unless including PDF as full size page.
    \thispagestyle{plain}

    % Since there are no appendix numbers because of the use of the command \section*{Appendices}, manually add a section to the Table of contents.
    \addcontentsline{toc}{section}{Appendices}

    % Command to renew \subsection command using alphabetical numbering
    \renewcommand{\thesubsection}{\Alph{subsection}}
        		
    % Leave this line alone
    \section*{Appendices}

    % Use this template to name each appendix
