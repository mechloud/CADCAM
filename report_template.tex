...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center} % Center everything on the page
			...
			\textsc{\Large Department of Mechanical Engineering}\\[1.0cm] % Major heading such as course name
			...
			%\begin{figure}[H]
			%	\centering
			%	\includegraphics[width=0.7\linewidth]{team_pic} % 0.7 times the width of the line
			%\end{figure}
