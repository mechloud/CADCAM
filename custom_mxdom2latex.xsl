...
\begin{par} \footnotesize \color{gray} \begin{flushright}
...
<!-- This section includes a latex comment instead of deleting the HTML -->
...
<!--Removed \begin{par} \end{par} and \vspace{1em} -->
...
\includegraphics [width=4in]{DIRECTORY/<xsl:value-of select="@src"/>}
</xsl:template>
